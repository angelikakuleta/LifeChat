         ...
         <section id='register' className="form">
            <div>
               ...
               <form onSubmit={this.handleClick}>
                  <div>
                     <input type='name' value={this.state.name} onChange={this.handleChangeName} placeholder='nazwa użytkownika' />
                  ...
                  <div>
                     <input type="password" value={this.state.password} onChange={this.handleChangePassword} placeholder='hasło' />
                     {this.state.errors.password && (<div className='error'>{this.state.errors.password}</div>)}
                  </div>
                  <input id='submit' type='submit' value='Zarejestruj się' disabled={this.state.isDisable} />
               </form>
            </div>
         </section>
      );
